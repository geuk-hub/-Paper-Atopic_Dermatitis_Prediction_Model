...
write.csv(train_data, file="Administractive district MLR model train data.csv", row.names = FALSE)
write.csv(test_data, file="Administractive district MLR model test data.csv", row.names = FALSE)

prediction <- matrix(predict(model, data))
write.csv(prediction, "Administractive district MLR model prediction data.csv", row.names = FALSE)
